...
class DataFeedsAccount(object):
    ...
    def sub_account_type(self, sub_account_type):
        ...
        :type: str
        """
        allowed_values = ["savings", "checking", "credit", "401k", "individual", "mortgage", "auto_loan", "roth", "rollover"]  # noqa: E501
        if self.local_vars_configuration.client_side_validation and sub_account_type not in allowed_values:  # noqa: E501
            raise ValueError(
                "Invalid value for `sub_account_type` ({0}), must be one of {1}"  # noqa: E501
                .format(sub_account_type, allowed_values)
            )
